...
<html lang="en">
	<head>
		...
		<!-- SITE TITLE -->
		<title>Chorbi - Single Project Page</title>			
...
<body>
	...
	<!-- END SECTION TOP -->
		...
		<section class="single_project_page">	
			<div class="container">
				<div class="row">
							...
							<div class="project_details">
								...
								<div class="about_project_details">
									<ul>
										...
										<li><i class="fa fa-clock-o"></i><b>Date: </b>24 May, 2024</li>
								...
								<a class="single_project_btn" href="#">See Live Project</a>
							</div>	
						</div>
					</div>
					<div class="col-lg-6 col-sm-12 col-xs-12">
						<div class="project_dec">
							<div class="single_project_img">
								<img src="assets/img/portfolio/3.jpg" class="img-fluid" alt="portfolio-image" />		
							</div>
							<div class="project_details">
								<div class="about_project">
									<h4>About Project</h4>
								...
								<div class="about_project_details">
									<ul>
										<li><i class="fa fa-user"></i><b>Client: </b>Google, Inc</li>
										<li><i class="fa fa-clock-o"></i><b>Date: </b>25 May, 2024</li>
										<li><i class="fa fa-folder"></i><b>Category: </b><a href="#">Web Design</a></li>
										<li><i class="fa fa-folder"></i><b>Project Url: </b><a href="#">www.google.com</a></li>
									</ul>
								</div>
		...
		<section class="related_single_project">
			<div class="container">
				<h4 class="similar_p">Similar <span>Projects</span></h4>
				<div class="row">					
